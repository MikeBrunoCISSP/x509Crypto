...
namespace Org.X509Crypto {
    ...
    //    /// </summary>
    public static class X509CryptoUtils {
        ...
        //        /// string plaintext = <see cref="X509CryptoUtils"/>.DecryptText(thumbprint, ciphertext, Context);
        //        /// </code>
        //        /// </example>
        ...
        //        /// bool success = <see cref="X509CryptoUtils"/>.DecryptFile(thumbprint, encryptedFilePath, certStore);
        //        /// </code>
        //        /// </example>
        ...
        //        /// string ciphertext = <see cref="X509CryptoUtils"/>.EncryptText(thumbprint, plaintext, certStore);
        //        /// </code>
        //        /// </example>
        ...
        //        /// bool success = <see cref="X509CryptoUtils"/>.EncryptFile(thumbprint, plaintextFilePath, certStore);
        //        /// </code>
        //        /// </example>
        ...
        //        /// string ciphertext = File.ReadAllText(@"C:\data\connectionString.txt");
        //        /// string updatedCiphertext = <see cref="X509CryptoUtils"/>.ReEncryptText(oldThumbprint, newThumbprint, ciphertext);
        ...
        //        /// string newThumbprint = @"0e7e327aab74e47a702c02d90c659da1115b29f7";
        //        /// string encryptedFilePath = @"C:\data\accounts.csv.ctx";
        //        /// <see cref="X509CryptoUtils"/>.ReEncryptFile"(oldThumbprint, newThumbprint, encryptedFilePath);
        //        /// </code>
        //        /// </example>
        ...
        //        /// <see cref="X509Context"/> certStore = <see cref="X509Context"/>.<see cref="X509Context.UserReadOnly"/>;
        //        /// string finalExportPath = <see cref="X509CryptoUtils"/>.ExportPFX(thumbprint, exportPath, password, certStore);
        ...
        //                    X509CryptoUtils.VerifyFile(exportPath);
        //                    return exportPath;
        //                }
        //            }
        ...
        //        /// <see cref="X509Context"/> certStore = <see cref="X509Context"/>.<see cref="X509Context.UserReadOnly"/>;
        //        /// string finalExportPath = <see cref="X509CryptoUtils"/>.ExportCert(thumbprint, exportPath, certStore);
        ...
        /// int timesToWrite = 10;
        /// <see cref="X509CryptoUtils"/>.<see cref="WipeFile"/>(path, timesToWrite);
        /// </code>
        /// </example>
        ...
        //        /// <example>
        //        /// <code>
        //        /// string availableCerts = <see cref="X509CryptoUtils"/>.<see cref="ListCerts"/>(<see cref="X509Context.UserReadOnly"/>);
        //        /// </code>
        //        /// </example>
